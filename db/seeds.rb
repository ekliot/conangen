...
talents = {
  acrobatics: [
    ...
    { name: "Lightning Reflexes",
      ...
      description: "Your quick reactions mean you are rarely caught unawares. When involved in a struggle to resist being surprised, you gain 2 bonus Momentum."
    },
  ...
  alchemy: [
    ...
    { name: "Master of Formulae",
      sourcebook_id: book_ids["Core"],
      pre_talents: { optional: { "Alchemist" => 1, "Patron" => 1 } },
      ...
      variants: [ "" ] # TODO various petty enchantments
    },
  ...
  athletics: [
    ...
    { name: "Iron Grasp",
      sourcebook_id: book_ids["Core"],
      pre_talents: { mandatory: { "Human Spider" => 1 } },
  ...
  insight: [
    ...
    { name: "See the Soul",
      ...
      pre_skills:  {},
      pre_talents: { mandatory: { "Sixth Sense" => 1 } },
      description: "While you might not literally see the human soul, you can intuitively relate your alternate senses to the physical world. When dealing with mortal humans you may use your Insight skill for Society and Thievery."
    },
  ...
  persuade: [
    { name: "Force of Presence",
      sourcebook_id: book_ids["Core"],
      pre_skills:  { persuade: { exp: 1, foc: 0 } },
    ...
    { name: "Remorseless",
      ...
      description: "You are willing and able to tell any lie that you feel is necessary to overcome an opponent’s social defenses. When lying to an opponent, you gain one additional d20 per rank of Remorseless to your Persuade or Command test, up to the normal maximum of three bonus d20s."
    },
  ...
  society: [
    ...
    { name: "Powerful Friends",
      ...
      variants: [ "First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth" ] # TODO how do we do this? that is, taking the talent multiple times, and gaining $focus friends each time...
    },
  ...
  sorcery: [
    ...
    { name: "Sorcerer",
      ...
      description: "Your character’s eyes are open to the horrible realities of the cosmos. Gain 1 spell and reduce the character’s resolve permanently by 2[CD]. See Chapter Seven: Sorcery for more details about this and other Sorcery talents.",
      variants: [] # TODO come back to this
    },
  ...
  stealth: [
    { name: "Assassin",
      ...
      description: "You are practiced in the art of murder, and taking lives no longer carries any emotional weight. When rolling damage with a melee weapon that has the Hidden quality, you may spend 2 points of Momentum in order to count every die in the pool as an Effect, instead of whatever was actually rolled. Additionally, you gain +2[CD] Courage Soak."
    },
  ...
  survival: [
    ...
    { name: "Risks",
      ...
      variants: ["Arctic", "Coastal", "Desert", "Forest", "Jungle", "Marsh/Swamp", "Mountain", "Plains", "Steppes", "Subterranean", "Urban", "*"] # TODO '*' ought to be considered as "custom" or "enter your own"
    },
  ...
  warfare: [
    { name: "Artillerist",
      sourcebook_id: book_ids["Core"],
      pre_skills:  { warfare: { exp: 1, foc: 0 } },
      pre_talents: { mandatory: { "Strategist" => 1 } },
      description: "You have learned how best to operate siege weaponry. When making an attack with a siege weapon, you may re-roll a number of damage dice equal to the number of Warfare talents (and ranks in them) you have acquired. The results of these re-rolls must be accepted."
    },
    ...
    { name: "Ballistics",
      ...
      description: "ou have experience firing large and inaccurate weapons over long distances, and have learned the techniques that make these weapons truly effective. For each rank of Ballistics, you can reduce the Difficulty of a Warfare test to attack with a siege weapon by one step, to a minimum of Average (D1). Each rank of Ballistics also increases the damage of a siege weapon used by +1[CD]."
    },

    { name: "Conqueror",
      sourcebook_id: book_ids["Core"],
      pre_skills:  { warfare: { exp: 2, foc: 0 } },
      pre_talents: { mandatory: { "General" => 1 } },
      description: "With this talent, you have learned how to bring your retinue (generated with the General talent) to bear with explosive force; any warrior in your retinue adds a bonus d20 to all Melee, Parry, Ranged Weapons, and Warfare tests. Warriors in your retinue no longer need to be within earshot to gain the benefit of your leadership. As with the General talent, this benefit does not apply to other player characters, even if they are under your control."
    },
  ...
  homeland: [
    ...
    { name: "Gilded",
      sourcebook_id: book_ids["Core"],
      description: "In a land where gold is commonplace, you have learned to spot those pretending to have wealth. In every scene, you can attempt to make a free Average (D1) Thievery or Craft test to gain a general feel for the wealth of a particular non-player character, or even the relative worth of an environment."
    },

    { name: "Honest Corruption",
      sourcebook_id: book_ids["Core"],
      description: "In a land of corrupt merchants and honest thieves, you have gained a sixth sense about those who are likely to betray you. When interacting with a non-player character for the first time, you can make a free Average (D1) Thievery or Counsel test to gain a general feel for the trustworthiness of the non-player character."
    },

    { name: "Hunter",
      sourcebook_id: book_ids["Core"],
      description: "You’ve lived with the wild as a constant neighbor, and know how to take from that environment what is necessary for survival. When in the rural parts of your homeland, the number of successes required for any Survival tests you attempt is reduced by 1, even if this reduces the Difficulty of the test to Simple (D0)."
    },
  ...
  other: [
    { name: "Ancient Bloodline",
      sourcebook_id: book_ids["Core"],
      description: "Any time you fail to make a Personality test of any kind, you must immediately pay the gamemaster 1 Doom point, and will gain an additional d20, adding its result to the test. The test is otherwise resolved in the normal fashion. If you have already spent Doom points to gain 3d20 to modify the Personality roll, you must pay the Doom point but do not get to roll the additional d20."
    }
  ]

}

prereq_types = [ :mandatory, :optional ]

talents.each do |skill, tree|
  tree.each do |talent|
    t = Talents::Talent.new( talent.except( :pre_talents, :pre_skills ) )
  ...
  tree.each do |talent|
    ...
    if talent.has_key? :pre_talents
      prereq_types.each do |type|

        if talent[:pre_talents].has_key? type
          talent[:pre_talents][type].each do |name, rank|

            Talents::PrereqTalent.create(
              min_rank: rank,
              mandatory: (type == :mandatory),
              requirer_id: talent_ids[talent[:name]],
              required_id: talent_ids[name]
            )
    ...
    if talent.has_key? :pre_skills
      talent[:pre_skills].each do |pre_skill, mins|

        Talents::PrereqSkill.create(
          min_exp: mins[:exp],
          min_foc: mins[:foc],
          requirer_id: talent_ids[talent[:name]],
          required_id: skill_ids[pre_skill.to_s]
        )
...
homelands = [
  { name: "Hyperborea",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Savage Court"],
    languages: ["Hyperborean"] },

  { name: "Border Kingdom",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Strife"],
    languages: ["Nemedian", "Hyperborean"] },

  { name: "Asgard",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Winter-born"],
    languages: ["Nordheimer"] },
  ...
  { name: "Zamora",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Honest Corruption"],
    languages: ["Zamorian"] },
  ...
  { name: "Stygia",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Desert-born"],
    languages: ["Stygian"] },

  { name: "Corinthia",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Strife"],
    languages: ["Corinthian"] },
  ...
  { name: "Zembabwei",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Desert-born"],
    languages: ["Zembabwein"] },

  { name: "The Black Kingdoms",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Strife"],
    languages: ["Kushite", "Darfari", "Keshani", "Punt"] },
  ...
  { name: "Hyrkania",
    sourcebook_id: book_ids["Core"],
    talent_id: talent_ids["Of Saddle and Bow"],
    languages: ["Hyrkanian"] },
...
aspects = [
  { name: "Strong and Resolute",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["willpower",   "brawn"],
      optional:  ["personality", "intelligence"]
    }
  },
  ...
  { name: "Acute and Aware",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["intelligence", "awareness"],
      optional:  ["coordination", "agility"]
    }
  },
  ...
  { name: "Fast and Fit",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["agility",   "brawn"],
      optional:  ["awareness", "coordination"]
    }
  },
  ...
  { name: "Eagle-eyed",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["coordination", "awareness"],
      optional:  ["intelligence", "personality"]
    }
  },
  ...
  { name: "Wise and Friendly",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["intelligence", "personality"],
      optional:  ["coordination", "brawn"]
    }
  },
  ...
  { name: "Socially Adept",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["awareness", "personality"],
      optional:  ["willpower", "agility"]
    }
  },
  ...
  { name: "Brave or Foolhardy",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["agility", "willpower"],
      optional:  ["brawn",   "coordination"]
    }
  },
  ...
  { name: "Dextrous",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["agility",   "cooridination"],
      optional:  ["willpower", "brawn"]
    }
  },
  ...
  { name: "Charismatic",
    sourcebook_id: book_ids["Core"],
    attrs: {
      mandatory: ["personality",  "willpower"],
      optional:  ["intelligence", "awareness"]
    }
  },
...
castes.each do |caste|
  c = Lifepath::Caste.create( caste )
  caste_ids[c.name] = c.id
end
...
caste_stories = {
  ...
  "Escaped Serf/Slave" => [
    ...
    { name: "Hidden Far from Noble Sight",
      ...
      caste_id: caste_ids["Escaped Serf/Slave"],
      sourcebook_id: book_ids["Core"],
      description: "Suddenly they died and you were alone. You could go anywhere, do anything. You took their money and spent every penny, constantly on the move. Then you found it: a perfect home, far from suspicious eyes. That home is gone now, just a memory that makes you smile. Where was that home, and what made it so special?" },

    { name: "One of the Multitudes",
      trait: "Marked by the Pit",
      caste_id: caste_ids["Escaped Serf/Slave"],
      sourcebook_id: book_ids["Core"],
      description: "Thousands of laborers toiled in the site as your master brought forth his vision. Conditions were cruel and many times you tasted the lash. As if by a miracle, the call came. As the uprising spread through the camp, with dozens of others you won your escape. Did you fight your oppressors valiantly, or did you slink away like a cur?" },

    { name: "Under the Eyes of the Masters",
      trait: "Stalked like Prey",
      caste_id: caste_ids["Escaped Serf/Slave"],
      sourcebook_id: book_ids["Core"],
      description: "They know you have escaped and they know where you have run. Perhaps they bide their time, or perhaps you are not worth the cost of retrieval. Still you know the strange one from the blackened tower has spies that watch your every step. Why is the strange one so interested in you?" },

    { name: "Hunted by Your Master",
      trait: "Nemesis",
      caste_id: caste_ids["Escaped Serf/Slave"],
      sourcebook_id: book_ids["Core"],
      description: "Your former master never forgot the indignity of your escape. Now with estate in ruins, she lives only for vengeance. Who is she and why does she hate you so much?" },

    { name: "Hunted by the Law",
      trait: "Hunted!",
      caste_id: caste_ids["Escaped Serf/Slave"],
      sourcebook_id: book_ids["Core"],
      description: "They’re on your track, crashing through taverns and looking in the alleys. Perhaps you committed the crime and it was worth it. Perhaps you are unjustly tormented. Either way a trail of suffering follows in your wake. Whose suffering do you regret the most and what will you do to put them at ease?" }
  ],

  "Farmer" => [
    { name: "Blessed Harvests",
      trait: "Family",
      caste_id: caste_ids["Farmer"],
      sourcebook_id: book_ids["Core"],
      description: "You remember fondly how hard work made the ground spill its bounty and how the seasons seemed to be fair. You remember the fellowship of your loved ones. Where are they now?" },

    { name: "Ample for Winter",
      trait: "Lost Love",
      caste_id: caste_ids["Farmer"],
      sourcebook_id: book_ids["Core"],
      description: "Every day brought a small hardship that made you strong. The ground was hard in summer and slush in winter, yet when the stores had to be opened there was always enough barley for a strong drink and plenty of food. Looking back, you scarcely remember the people of your village. Should you return, they would scarce remember you. Perhaps there is someone there worth returning to see. Do you even remember that person’s name?" },

    { name: "Winter in the Balance",
      trait: "Vengeance",
      caste_id: caste_ids["Farmer"],
      sourcebook_id: book_ids["Core"],
      description: "It was a struggle every year. The lord took plenty for his knights, leaving little for the common folk. Sometimes you ate, while other times you simply drank snow water and slept as the wolves howled. You remember no beauty in that bleak place — only the torments of the thieving knights. One knight in particular took pleasure in the hardship he inflicted. If you meet him again, will you take revenge? Why?" },

    { name: "Meager Soup and Angry Eyes",
      trait: "Traitor",
      caste_id: caste_ids["Farmer"],
      sourcebook_id: book_ids["Core"],
      description: "Even the protectors of your village went hungry, and when they did, everyone suffered. Raids were planned on other villages, but you never saw any of the food they brought back. The only way to survive was by poaching, but the game was scarce and you had to keep your kills to yourself. Eventually, you were found out and the angry eyes of the villagers were terrible to behold. Were you punished, and did you ever redeem yourself?" },

    { name: "Not a Spare Bean",
      trait: "Trusted of Traitor",
      caste_id: caste_ids["Farmer"],
      sourcebook_id: book_ids["Core"],
      description: "You remember seeing the warrior die. He simply stopped and fell, his armor clattering on the stony ground. He had come to take taxes for the fifth time, but there was no food or other wealth to be had. When he learned he could take nothing from you and your kin, he just stopped, as if his soul had given up, onwards to some other place of plenitude. The horse was short work for the butcher and you were sent south to find someone to buy the man’s sword. Did you find a buyer? Did you take the profits home? " },

    { name: "Famine",
      trait: "Cannibal",
      caste_id: caste_ids["Farmer"],
      sourcebook_id: book_ids["Core"],
      description: "When the crops were gone, you ate the beasts of the forest. Then you killed and shared the beasts that worked your fields. As water became a luxury, some in your village looked at the soft flesh of the masters and contemplated a different type of prey. As the knife sunk deep into the land-owner’s agent rain began to fall. You looked on in horror, as desperation revealed its ugliest side. You were forced to ask yourself the hardest question. How hungry were you?" }
  ],

  "Herder" => [
    { name: "A Heavy Lambing Season",
      trait: "Exotic tastes",
      caste_id: caste_ids["Herder"],
      sourcebook_id: book_ids["Core"],
      description: "You scarcely remember the work, but you’ll never forget the noise. An endless chorus of bleats, swearing, and the wet sounds of butchery. When the season was over, you were rich enough to afford comforts your forbears had never indulged in. What did you get a taste for, and does it tempt you still?" },

    { name: "Nights of Sweet Silence",
      trait: "Hedonist",
      caste_id: caste_ids["Herder"],
      sourcebook_id: book_ids["Core"],
      description: "You remember the hills where you rested, sandwiched between the grasses and scented herbs of the wild. The days were tender and the nights were long. You spent more time at play than at work, and gained memories that still lighten your heart, even in leaner years. Of these, what is your fondest memory?" },

    { name: "Howls in the Night",
      trait: "Nightmares",
      caste_id: caste_ids["Herder"],
      sourcebook_id: book_ids["Core"],
      description: "Wolves were only an occasional threat, but tell that to your aunt. She was determined to make you a masterful wolf hunter, even if she had to beat the lessons into you. Despite all the training, you only remember hearing howls once. Your aunt woke you quietly and with you went into the forest, brandishing fire and steel. When you emerged into daylight, she seemed a hundred years older and you never slept properly again. What dreams haunt you still?" },

    { name: "A Decimated Herd",
      trait: "Survivor",
      caste_id: caste_ids["Herder"],
      sourcebook_id: book_ids["Core"],
      description: "The illness left many dead in its wake. Superstition had its way, and even more of the herd were sacrificed to save the healthy. When the plague had passed, only one in five lived. The herd was doomed. Your cattle master drove the remainder to town, where they were slaughtered and the money divided amongst you. In the morning, you found him hanged with a lock of his wife’s hair still woven around his fingers. Just the night before he had seemed so wise. What was the last thing he said to you?" },

    { name: "Wolves Amongst the Flock",
      trait: "Compassionate",
      caste_id: caste_ids["Herder"],
      sourcebook_id: book_ids["Core"],
      description: "It was only natural in the hard winter that the wolves would find you. At first, they were the nuisance they had always been, but as the snows grew deeper the tracks got larger. Somewhere in the forest, a great wolf was gathering a pack larger than any seen before. Foresters would go in gangs to gather firewood, but you quickly found yourself lost. In the snow while carrying a bundle of wet branches, you saw it and looked into its eyes. To this day those eyes haunt you. What did you see and why did it let you live?" },

    { name: "Raiders",
      trait: "Vengeful",
      caste_id: caste_ids["Herder"],
      sourcebook_id: book_ids["Core"],
      description: "First there was nothing but thin trails of smoke, off in the distance. Soon there was the report of laughter, carried as if on the wind. In hushed tones, the old men of your village whispered a word that carried with it a weight of dread… “Raiders!” The fences were surrounded with traps and the able-bodied in your village were set as guards. On the third night the raiders struck. Half the herd was stolen and fifteen were placed upon the pyre. Finally, it was time for the young to speak and your voice joined many. What did you do, and what was the cost?" }
  ],

  "Merchant" => [
    { name: "Extravagant Profits",
      trait: "Ostentatious",
      caste_id: caste_ids["Merchant"],
      sourcebook_id: book_ids["Core"],
      description: "There was only ever celebration in your grandfather’s house. Granted a monopoly long ago, he sold his goods for a handsome price, and his competitors had no recourse when his soldiers confiscated or taxed their goods on the road to town. You were a noble in all but name, but it did not last. Now the old man is dead and the monopolies returned to the prince who increases the taxation on your properties to ruinous amounts. While he was alive, the old man had a motto that governed all his business dealings. What was that motto, and do you agree with it?" },

    { name: "Profits from the Town",
      trait: "Spy",
      caste_id: caste_ids["Merchant"],
      sourcebook_id: book_ids["Core"],
      description: "While working in your aunt’s home you got to see many wealthy visitors stop by and broker purchases. You were young enough that they didn’t pay you much mind unless you were serving wine. Consequently, you learned a great deal that the visitors didn’t want your aunt to know. A generous woman, she always made sure you were rewarded whenever a significant deal was brokered. What was your biggest score, and did the customer ever find out?" },

    { name: "Profits from the Road",
      trait: "Well-traveled",
      caste_id: caste_ids["Merchant"],
      sourcebook_id: book_ids["Core"],
      description: "It seemed like you were always on the move. Taking goods from one town, trading them for goods in the next, pocketing some coin along the way. Spending the coin on some cheap wine, and then moving on. It was easy to become embittered about your cousins, living it up in the city while you plied your way through the expanses on dangerous caravan routes. Still, it’s not like you didn’t have adventures or see amazing sights. What was the most amazing thing you have ever seen?" },

    { name: "The Lash of Taxation",
      trait: "Witness to Brutality",
      caste_id: caste_ids["Merchant"],
      sourcebook_id: book_ids["Core"],
      description: "Your local lord had grandiose dreams and a mind to have the merchants within his lands pay for them. You learned that sometimes a merchant needs to be have two cargoes: one to be seen, and one to pay for the trip. You also witnessed firsthand what happens to smugglers. Who did you see suffering at the hands of the lord’s soldiers?" },

    { name: "Hard-won Profits",
      trait: "Divided Family",
      caste_id: caste_ids["Merchant"],
      sourcebook_id: book_ids["Core"],
      description: "When you were young, a bandit lord took to plundering your family’s caravans. At first, mercenaries were hired, but they deserted and joined the bandits in their plunder. Then, soldiers were borrowed from the king but the taxes on that service were exorbitant. You spoke up and offered a plan that made half your family revile you and the rest love you. What was your plan, and why was it so effective?" },

    { name: "Ruin",
      trait: "Vengeful",
      caste_id: caste_ids["Merchant"],
      sourcebook_id: book_ids["Core"],
      description: "Your family had been making profits and living well. You were not one of the most powerful families but you had enough long-lasting ties that your future seemed secure. Over the course of one banquet, all this changed. Your uncle offended one of the more powerful courtiers, and the courtier made it his mission to destroy your family. By the time the courtier was done, your family’s name was in ruin. The king granted your rivals monopolies that blocked your goods from entry to the larger cities, and bandits harassed your caravans. When the fire took your family’s estate, you were left thoroughly dispossessed. Now that you’ve started to rise, you must consider your options. What vengeance, if any, will you take upon the courtier? How will you escape his wrath?" }
  ],

  "Outcast" => [
    { name: "The Charity of Honest Men",
      trait: "Honor Debt",
      caste_id: caste_ids["Outcast"],
      sourcebook_id: book_ids["Core"],
      description: "While you might not be the most pathetic of the beggars, in a time of need a charitable man of means gave food and shelter enough to survive. What had enfeebled you, and who was your benefactor?" },

    { name: "The Charity of Pompous Priests",
      trait: "Theif!",
      caste_id: caste_ids["Outcast"],
      sourcebook_id: book_ids["Core"],
      description: "As a display of piety, a priest took you in and read to you boring sermons, hour after hour. While you stayed with the priest, you saw many treasures and ate scraps that at any other table would be the height of dining. Did you take anything from the priest’s home, and is your theft known?" },

    { name: "Food and Rough Liqour",
      trait: "Fond Regrets",
      caste_id: caste_ids["Outcast"],
      sourcebook_id: book_ids["Core"],
      description: "The rabble of your shanty might not have had much, but it was shared with cheer and many fond (if humble) memories were made. Now this shanty is no more. What befell its inhabitants? Did any survive?" },

    { name: "One of the Rabble",
      trait: "Betrayed",
      caste_id: caste_ids["Outcast"],
      sourcebook_id: book_ids["Core"],
      description: "There were hundreds squabbling over food in the shadows of the lord’s fealty. Betrayal was a part of life, but you never expected it from your fellow outcasts. Who betrayed you, and why do you still feel the sting of the betrayal?" },

    { name: "Shunned Even by Lepers",
      trait: "Cursed",
      caste_id: caste_ids["Outcast"],
      sourcebook_id: book_ids["Core"],
      description: "There was a time you were doing well for one of the ragged, but then something happened. You barely remember how or why it happened, but it marked you as surely as if it were branded upon your face. Why do the beggars spit at your shadow? Are there any that remember you with kindness?" },

    { name: "Hunted by the Law",
      trait: "Hunted!",
      caste_id: caste_ids["Outcast"],
      sourcebook_id: book_ids["Core"],
      description: "They’re on your track, crashing through taverns and looking in the alleys you used to haunt. Perhaps you committed the crime and it was worth it. Perhaps you are unjustly persecuted. Either way, a trail of suffering follows in your wake. Whose suffering do you regret the most and what will you do to put them at ease?" }
  ],

  "Petty Nobility" =>[
    { name: "Guest of a Greater Name",
      trait: "Chosen",
      caste_id: caste_ids["Petty Nobility"],
      sourcebook_id: book_ids["Core"],
...
archetypes = [
  ...
  { name:          "Mercenary",
    sourcebook_id: book_ids["Core"],
    talent_id:     talent_ids["Strong Back"],
  ...
  { name:          "Noble Warrior",
    sourcebook_id: book_ids["Core"],
    talent_id:     talent_ids["A Modicum of Comfort"],
  ...
  { name:          "Priest/Priestess",
    sourcebook_id: book_ids["Core"],
    talent_id:     talent_ids["Quiet Wisdom"],
    ...
    skills: {
      career:     "counsel",
      mandatory: ["insight", "lore",    "persuade", "society"],
  ...
  { name:          "Pirate",
    sourcebook_id: book_ids["Core"],
    talent_id:     talent_ids["Sharp Senses"],
    description:   "You may once have been a sailor, a merchant, or even a member of one of the great navies, but eventually you turned your hand towards piracy. More at home on the open water than on land, you are nonetheless willing to seek your fortune wherever fate guides you.",
    skills: {
      career:     "observation",
      mandatory: ["melee",   "parry",   "resistance", "survival"],
      elective:  ["sailing", "stealth", "thievery"],
    },
    equipment: {}
  },
  ...
  { name:          "Scoundrel",
    ...
    skills: {
      career:     "acrobatics",
      mandatory: ["athletics", "parry",   "persuade", "society"],
      elective:  ["melee",     "stealth", "thievery"],
    },
    equipment: {}
  },
  ...
  { name:          "Witch/Shaman",
    sourcebook_id: book_ids["Core"],
    talent_id:     talent_ids["Force of Presence"],
...
natures = [
  ...
  { name: "Curious",
    ...
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["athletics", "observation", "stealth"],
      elective:  ["alchemy",   "lore",        "thievery"]
    },
  ...
  { name: "Inspirational",
    ...
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["counsel", "observation", "persuade"],
      elective:  ["command", "healing",     "society"]
    },
  ...
  { name: "Scheming",
    ...
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["command",    "counsel", "discipline"],
      elective:  ["acrobatics", "lore",    "parry"]
    },
  ...
  { name: "Stoic",
    ...
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["discipline", "lore", "resistance"],
      elective:  ["counsel", "healing", "parry"]
    },
...
educations = [
  { name:         "Against Your Parents' Will",
    ...
    equipment: {
      mandatory: {
        other: ["A broken family heirloom"]
      }
    },
  ...
  { name:         "Apprenticed Abroad",
    ...
    equipment: {
      mandatory: {
        other: ["A selection of useful maps of the Hyborian kingdoms"]
      }
    },
  ...
  { name:         "Educated on the Battlefield",
    ...
    equipment: {
      choices: [
        { other: ["A melee weapon of choice and a helmet (Armor 3: Head)"] },
        { other: ["A battlefield honor"] }
      ]
    },
    # equipment: {
    #   choices: [
    #     EquipmentList( weapon: { melee: ["any"] }, armor: { head: ["Helmet"] } ),
    #     EquipmentList( other:  ["A battlefield honor"] )
    #   ]
    # },
  ...
  { name:         "Educated by Masterful Tutors",
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["discipline", "lore",     "career"],
      elective:  ["resistance", "survival", "career"]
    },
    equipment: {
      mandatory: {
        other: ["Letter of praise and introduction from your tutor"]
      }
    },
  ...
  { name:         "Elder Mentor",
    ...
    equipment: {
      mandatory: {
        other: ["A piece of equipment from your mentor’s archetype"]
      }
    },
  ...
  { name:         "Family Footsteps",
    ...
    equipment: {
      mandatory: {
        other: ["A family heirloom of little more than sentimental value"]
      }
    },
  ...
  { name:         "Largely Absent",
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["athletics",  "persuade",    "career"],
      elective:  ["acrobatics", "observation", "resistance"]
    },
    equipment:    {},
  ...
  { name:         "On Your Own Terms",
    sourcebook_id: book_ids["Core"],
    skills: {
      mandatory: ["acrobatics", "athletics", "stealth"],
      elective:  ["craft",      "lore",      "survival"]
    },
    equipment:    {},
  ...
  { name:         "Traditional",
    ...
    equipment: {
      choices: [
        { other: ["A heavy cape (Armor 1: Torso/Legs)"] },
        { other: ["Crafting tools"] },
        { other: ["A melee weapon of choice"] }
      ]
    },
...
war_stories = [
  ...
  { name: "Dispossessed",
    sourcebook_id: book_ids["Core"],
    skills: ["resistance", "survival"]
  },

  { name: "Gained (and Lost) a Great Treasure",
    sourcebook_id: book_ids["Core"],
    skills: ["observation", "society"]
  },

  { name: "Gained the Favor of a Local Noble",
    sourcebook_id: book_ids["Core"],
    skills: ["persuade", "society"]
  },
  ...
  { name: "Shipwrecked",
    sourcebook_id: book_ids["Core"],
    skills: ["athletics", "sailing"]
  },

  { name: "Survived a Duel",
    sourcebook_id: book_ids["Core"],
    skills: ["parry", "resistance"]
  },
  ...
  { name: "Survived a Stint at Court",
    sourcebook_id: book_ids["Core"],
    skills: ["insight", "society"]
  },

  { name: "Survived Witchcraft or Sorcery",
    sourcebook_id: book_ids["Core"],
    skills: ["discipline", "sorcery"]
  }
]
